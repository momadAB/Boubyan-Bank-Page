...
function ApplySection() {
  return (
    <div className="w-[80%] m-auto p-5 font-sans">
      <main>
        {/* Header Section */}
        ...
        <div className="relative flex justify-center mt-10 space-x-8 mt-[-5rem]">
          {/* Left Column */}
          <div className="w-[40%] space-y-20 relative top-0">
          ...
          >
            ...
            <Image
              ...
              width={1.7}
              height={50}
              className="absolute max-w-none mt-[-5rem]"
            />
          ...
          {/* Right Column */}
          <div className="w-[45%] space-y-20 relative top-20">
